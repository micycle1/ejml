...
/**
 * Symmetric Reverse Cuthill-McKee (RCM) ordering for {@link DMatrixSparseCSC}.
 */
public final class SymmetricRCM {
     ...
     */
    public static void compute( DMatrixSparseCSC A, boolean sortByDegree, IGrowArray perm ) {
