 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.sparse.csc.TestMatrixFeatures_DSCC")
public class TestMatrixFeatures_FSCC extends EjmlStandardJUnit {
    @Test
    public void isEquals() {
        ...
        FMatrixSparseCSC b = FConvertMatrixStruct.convert(orig,(FMatrixSparseCSC)null);
    ...
    public void isLowerTriangle() {
        ...
        FMatrixSparseCSC L = FConvertMatrixStruct.convert(D,(FMatrixSparseCSC)null, UtilEjml.F_EPS);
        ...
        L = FConvertMatrixStruct.convert(D,(FMatrixSparseCSC)null, UtilEjml.F_EPS);
    ...
    public void isTranspose() {
        ...
        // convert to sparse
        FMatrixSparseCSC A = FConvertMatrixStruct.convert(Ad,(FMatrixSparseCSC)null, UtilEjml.F_EPS);
        FMatrixSparseCSC At = FConvertMatrixStruct.convert(Ad_tran,(FMatrixSparseCSC)null, UtilEjml.F_EPS);
    ...
    public void isSymmetric() {
        ...
        for (int N = 1; N < 10; N++) {
            for (int mc = 0; mc < 30; mc++) {
                ...
                // C must be symmetric
                CommonOps_FSCC.mult(A,A_t,C,null,null);
