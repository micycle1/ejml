 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.sparse.csc.decomposition.qr.TestQrHelperFunctions_DSCC")
public class TestQrHelperFunctions_FSCC extends EjmlStandardJUnit {
    ...
    public void rank1UpdateMultR() {
        ...
        FMatrixSparseCSC v_t = CommonOps_FSCC.transpose(v,null,null);
        CommonOps_FSCC.mult(v_t,A,vA,null,null);
        // B = -gamma*v*(v'*A)
