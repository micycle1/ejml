 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.sparse.csc.decomposition.lu.GenericLuTests_DSCC")
public abstract class GenericLuTests_FSCC extends GenericDecompositionTests_FSCC {
    ...
    private void checkSolution( FMatrixSparseCSC A, LUSparseDecomposition_F32<FMatrixSparseCSC> lu ) {
        ...
        FMatrixSparseCSC P_t = CommonOps_FSCC.transpose(P, null, null);
        CommonOps_FSCC.mult(P_t, L, PL, null, null);
    ...
    private void checkDeterminantToDense( FillReducing perm ) {
        for (int trial = 0; trial < 60; trial++) {
            ...
            FMatrixSparseCSC A_sp = FConvertMatrixStruct.convert(A, (FMatrixSparseCSC)null, UtilEjml.F_EPS);
