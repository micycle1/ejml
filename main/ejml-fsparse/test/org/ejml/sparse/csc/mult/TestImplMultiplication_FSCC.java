 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.sparse.csc.mult.TestImplMultiplication_DSCC")
public class TestImplMultiplication_FSCC extends EjmlStandardJUnit {
    FGrowArray workArray = new FGrowArray();
    ...
    private void mult_s_s( int rowsA, int colsA, int colsB ) {
        ...
        ImplMultiplication_FSCC.mult(a, b, c, null, null);
        assertTrue(CommonOps_FSCC.checkStructure(c));

        FMatrixRMaj dense_a = FConvertMatrixStruct.convert(a, (FMatrixRMaj)null);
        FMatrixRMaj dense_b = FConvertMatrixStruct.convert(b, (FMatrixRMaj)null);
    ...
    private void mult_s_d( int elementsA, boolean add ) {
        ...
        if (add) {
            ...
            ImplMultiplication_FSCC.mult(a, b, c);
    ...
    private void multTransA_s_d( int elementsA, boolean add ) {
        ...
        if (add) {
            ImplMultiplication_FSCC.multAddTransA(a, b, c, workArray);
            CommonOps_FDRM.multAddTransA(dense_a, b, expected_c);
        } else {
            ImplMultiplication_FSCC.multTransA(a, b, c, workArray);
    ...
    private void multTransB_s_d( int elementsA, boolean add ) {
        ...
        if (add) {
            ...
            ImplMultiplication_FSCC.multTransB(a, b, c, workArray);
    ...
    private void multTransAB_s_d( int elementsA, boolean add ) {
        ...
        if (add) {
            ImplMultiplication_FSCC.multAddTransAB(a, b, c);
            CommonOps_FDRM.multAddTransAB(dense_a, b, expected_c);
        } else {
            ImplMultiplication_FSCC.multTransAB(a, b, c);
    ...
    @Test void addRowsInAInToC() {
        ...
        ImplMultiplication_FSCC.addRowsInAInToC(A, 0, B, 0, w);
        assertEquals(0, B.col_idx[1]);

        // colA shoul dnow be added to colB
        ImplMultiplication_FSCC.addRowsInAInToC(A, 0, B, 1, w);
    ...
    @Test void dotInnerColumns() {
        ...
        for (int mc = 0; mc < 50; mc++) {
            ...
            float found = ImplMultiplication_FSCC.dotInnerColumns(A, colA, B, colB, gw, gx);
