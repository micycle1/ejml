 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.dense.row.linsol.GenericLinearSolverChecks_ZDRM")
public abstract class GenericLinearSolverChecks_CDRM extends EjmlStandardJUnit {
    ...
    public void solve_dimensionCheck() {
        ...
        // It should resize x
        CMatrixRMaj x = RandomMatrices_CDRM.rectangle(1, 1, rand);
        try {
    ...
    public void inverse() {
        for (int i = 2; i < 10; i++) {
            ...
            CMatrixRMaj A_inv = RandomMatrices_CDRM.rectangle(i, 2, rand);
