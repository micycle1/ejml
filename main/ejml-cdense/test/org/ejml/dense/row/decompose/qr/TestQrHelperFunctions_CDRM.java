...
@Generated("org.ejml.dense.row.decompose.qr.TestQrHelperFunctions_ZDRM")
public class TestQrHelperFunctions_CDRM extends EjmlStandardJUnit {
    @Test
    public void findMax() {
    ...
    public void computeTauGammaAndDivide() {
        ...
        float expectedGamma = 2.0f/normU;
