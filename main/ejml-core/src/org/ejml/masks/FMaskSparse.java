 ...
 */
@Generated("org.ejml.masks.DMaskSparse")
public class FMaskSparse extends Mask {
    ...
    /**
     * Utility class to build {@link FMaskSparse}
     */
    public static class Builder extends MaskBuilder<FMaskSparse> {
        ...
        public FMaskSparse build() {
            return new FMaskSparse(matrix, negated, zeroElement, gw, indexFirstColumn);
        }
    }
}
