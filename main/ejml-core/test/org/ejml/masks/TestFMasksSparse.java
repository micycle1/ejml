...
@Generated("org.ejml.masks.TestDMasksSparse")
public class TestFMasksSparse extends EjmlStandardJUnit {
    ...
    private static Stream<Arguments> maskAndExpectedMaxEntries() {
        ...
        var maskBuilder = new FMaskSparse.Builder(maskMatrix);
    ...
    void mask() {
        ...
        FMaskSparse.Builder builder = new FMaskSparse.Builder(matrix);
