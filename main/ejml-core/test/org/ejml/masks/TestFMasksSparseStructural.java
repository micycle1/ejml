...
@Generated("org.ejml.masks.TestDMasksSparseStructural")
public class TestFMasksSparseStructural extends EjmlStandardJUnit {

    private static Stream<Arguments> maskAndExpectedMaxEntries() {
        FMatrixSparseCSC maskMatrix = RandomMatrices_FSCC.rectangle(10, 10, 20, new Random(42));
        var maskBuilder = new FMaskSparseStructural.Builder(maskMatrix);
    ...
    void masks() {
        int dim = 10;
        FMatrixSparseCSC matrix = RandomMatrices_FSCC.rectangle(dim, dim, 50, new Random(42));

        FMaskSparseStructural.Builder builder = new FMaskSparseStructural.Builder(matrix);
