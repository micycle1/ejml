...
@Generated("org.ejml.data.TestDMatrixRMaj")
public class TestFMatrixRMaj extends EjmlStandardJUnit {
     ...
     */
    @Test void testConstruactorFloatArray() {
        float[][] d = new float[][]{{1, 2}, {3, 4}, {5, 6}};
    ...
    @Test void get2DData() {
        ...
        float[][] actual = new FMatrixRMaj(expected).get2DData();

        assertArrayEquals(expected, actual);
        assertEquals(0, actual[0][0], UtilEjml.TEST_F32);
        assertEquals(1, actual[0][1], UtilEjml.TEST_F32);
        assertEquals(2, actual[1][0], UtilEjml.TEST_F32);
        assertEquals(3, actual[1][1], UtilEjml.TEST_F32);
    }
}
