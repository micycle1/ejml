 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.data.GenericTestsZMatrixD1")
public abstract class GenericTestsCMatrixD1 extends GenericTestsCMatrix {

    @Override
    protected abstract CMatrixD1 createMatrix( int numRows, int numCols );
    ...
    public void testReshape() {
        CMatrixD1 mat = createMatrix(3, 2);
