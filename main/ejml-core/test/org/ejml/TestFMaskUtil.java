...
@Generated("org.ejml.TestDMaskUtil")
public class TestFMaskUtil extends EjmlStandardJUnit {
    public static void assertMaskedResult( FMatrixSparseCSC unmaskedResult, FMatrixSparseCSC maskedResult, Mask mask ) {
    ...
    public static void assertMaskedResult( float[] unmaskedResult, float[] maskedResult, Mask mask ) {
