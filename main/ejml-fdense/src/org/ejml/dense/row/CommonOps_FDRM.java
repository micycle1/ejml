...
public class CommonOps_FDRM {
     ...
     */
    public static BMatrixRMaj elementLessThan( FMatrixRMaj A, float value, @Nullable BMatrixRMaj output ) {
     ...
     * @see #elementBoolean for a more generalized element wise binary operator
     */
    public static BMatrixRMaj elementLessThanOrEqual( FMatrixRMaj A, float value, @Nullable BMatrixRMaj output ) {
        output = UtilEjml.reshapeOrDeclare(output, A.numRows, A.numCols);
     ...
     * @see #elementBoolean for a more generalized element wise binary operator
     */
    public static BMatrixRMaj elementMoreThan( FMatrixRMaj A, float value, @Nullable BMatrixRMaj output ) {
        output = UtilEjml.reshapeOrDeclare(output, A.numRows, A.numCols);
     ...
     * @see #elementBoolean for a more generalized element wise binary operator
     */
    public static BMatrixRMaj elementMoreThanOrEqual( FMatrixRMaj A, float value, @Nullable BMatrixRMaj output ) {
        output = UtilEjml.reshapeOrDeclare(output, A.numRows, A.numCols);
     ...
     * @see #elementBoolean for a more generalized element wise binary operator
     */
    public static BMatrixRMaj elementLessThan( FMatrixRMaj A, FMatrixRMaj B, @Nullable BMatrixRMaj output ) {
        output = UtilEjml.reshapeOrDeclare(output, A.numRows, A.numCols);
     ...
     * @see #elementBoolean for a more generalized element wise binary operator
     */
    public static BMatrixRMaj elementLessThanOrEqual( FMatrixRMaj A, FMatrixRMaj B, @Nullable BMatrixRMaj output ) {
        output = UtilEjml.reshapeOrDeclare(output, A.numRows, A.numCols);
     ...
     * <pre>BMatrixRMaj found = CommonOps_FDRM.elementBoolean(A, ( row, col, value ) -> B.get(row, col) < value, null);</pre>
     *
     * @param input Input matrix
     ...
     */
    public static BMatrixRMaj elementBoolean( FMatrixRMaj input,
