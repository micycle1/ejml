...
@Generated("org.ejml.dense.block.decomposition.qr.TestBlockHouseHolder_DDRB")
class TestBlockHouseHolder_FDRB extends EjmlStandardJUnit {
    // the block length
    int r = 3;
...
//            System.out.println("width "+width);
    ...
    void computeW_Column() {
        ...
        BlockHouseHolder_FDRB.computeW_Column(r, Ab_sub, Wb_sub, null, betas, 0);
