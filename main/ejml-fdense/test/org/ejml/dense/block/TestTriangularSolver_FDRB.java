 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.dense.block.TestTriangularSolver_DDRB")
public class TestTriangularSolver_FDRB extends EjmlStandardJUnit {
    @Test
    void invert_two() {
        // block size
        int r = 3;

        var workspace = new GrowArray<>(FGrowArray::new);
        ...
        for (int size = 1; size <= 9; size++) {
            ...
            TriangularSolver_FDRB.invert(r, false, new FSubmatrixD1(T), new FSubmatrixD1(T_inv), workspace);
            ...
            TriangularSolver_FDRB.invert(r, false, new FSubmatrixD1(T), new FSubmatrixD1(T), workspace);
    ...
    void invert_one() {
        ...
        for (int size = 1; size <= 9; size++) {
            ...
            TriangularSolver_FDRB.invert(r, false, new FSubmatrixD1(T_inv), workspace);
