...
@Generated("org.ejml.dense.block.TestMatrixOps_DDRB")
public class TestMatrixOps_FDRB extends EjmlStandardJUnit {
    ...
    @Test
    void convertInplace_FDRM_FDRB() {
        int r = 3;
        FMatrixRMaj A = RandomMatrices_FDRM.rectangle(23, 21, rand);
        FMatrixRMaj A_orig = A.copy();

        FMatrixRBlock B = MatrixOps_FDRB.convertInplace(A,new FMatrixRBlock(1,1,r),null);
    ...
    @Test
    void convertInplace_FDRB_FDRM() {
        int r = 3;
        FMatrixRBlock B = MatrixOps_FDRB.createRandom(23, 21, -1, 1, rand, r);
        FMatrixRBlock B_orig = B.copy();

        FMatrixRMaj A = MatrixOps_FDRB.convertInplace(B,null,null);

        assertTrue(GenericMatrixOps_F32.isEquivalent(B_orig, A, UtilEjml.TEST_F32));
    ...
    private void checkConvertInline_dense_to_block( int m, int n ) {
        ...
        MatrixOps_FDRB.convertRowToBlock(m, n, BLOCK_LENGTH, A.data, null);
    ...
    private void checkConvertInline_block_to_dense( int m, int n ) {
        ...
        MatrixOps_FDRB.convertBlockToRow(m, n, BLOCK_LENGTH, A.data, null);
