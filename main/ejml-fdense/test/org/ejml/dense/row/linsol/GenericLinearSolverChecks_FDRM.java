 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.dense.row.linsol.GenericLinearSolverChecks_DDRM")
public abstract class GenericLinearSolverChecks_FDRM extends EjmlStandardJUnit {
    ...
    @Test void zeroSizedMatrix() {
        FMatrixRMaj A = RandomMatrices_FDRM.rectangle(0, 0, rand);

        LinearSolverDense<FMatrixRMaj> solver = createSafeSolver(A);
        assertTrue(solver.setA(A));

        FMatrixRMaj x = RandomMatrices_FDRM.rectangle(0, 0, rand);
        FMatrixRMaj b = RandomMatrices_FDRM.rectangle(0, 0, rand);
