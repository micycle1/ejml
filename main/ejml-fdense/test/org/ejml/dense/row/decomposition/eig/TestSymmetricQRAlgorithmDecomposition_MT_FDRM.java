 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.dense.row.decomposition.eig.TestSymmetricQRAlgorithmDecomposition_MT_DDRM")
public class TestSymmetricQRAlgorithmDecomposition_MT_FDRM extends EjmlStandardJUnit {
    int size = 100;
    ...
    void compareToSingle( boolean vectors ) {
        ...
        var single = new SymmetricQRAlgorithmDecomposition_FDRM(new TridiagonalDecompositionHouseholder_FDRM(), vectors);
        var concurrent = new SymmetricQRAlgorithmDecomposition_FDRM(new TridiagonalDecompositionHouseholder_MT_FDRM(), vectors);
