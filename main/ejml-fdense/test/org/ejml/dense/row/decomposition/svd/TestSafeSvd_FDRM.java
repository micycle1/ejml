...
@Generated("org.ejml.dense.row.decomposition.svd.TestSafeSvd_DDRM")
public class TestSafeSvd_FDRM extends EjmlStandardJUnit {
   @Test void getSafety() {
        ...
        SingularValueDecomposition<FMatrixRMaj> decomp = new SafeSvd_FDRM(dummy);
   ...
   @Test void checkOtherFunctions() {
    ...
    protected static class Dummy implements SingularValueDecomposition_F32<FMatrixRMaj> {
        ...
        @Override public float[] getSingularValues() {
            return singular;
        }
        ...
        @Override public FMatrixRMaj getU( FMatrixRMaj U, boolean transposed ) {
            getU_called = true;
            return null;
        }

        @Override public FMatrixRMaj getV( FMatrixRMaj V, boolean transposed ) {
            getV_called = true;
            return null;
        }

        @Override public FMatrixRMaj getW( FMatrixRMaj W ) {
            getW_called = true;
            return null;
        }
        ...
        @Override public boolean decompose( FMatrixRMaj orig ) {
