...
@Generated("org.ejml.dense.row.decomposition.qr.TestQRDecompositionHouseholderTran_DDRM")
public class TestQRDecompositionHouseholderTran_FDRM extends GenericQrCheck_FDRM {
    ...
    private void checkSubMatrix( int width, int w ) {
        ...
        var U = new SimpleMatrix(width, 1, FMatrixRMaj.class);
        var A = new SimpleMatrix(width, width, FMatrixRMaj.class);
