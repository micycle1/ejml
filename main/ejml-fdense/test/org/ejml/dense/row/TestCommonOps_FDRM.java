...
@Generated("org.ejml.dense.row.TestCommonOps_DDRM")
public class TestCommonOps_FDRM extends EjmlStandardJUnit {
...
//                System.out.println(N+" "+j);
    ...
    @Test void subtract_matrix_float() {
        FMatrixRMaj a = new FMatrixRMaj(2, 3, true, 0, 1, 2, 3, 4, 5);
        FMatrixRMaj c = RandomMatrices_FDRM.rectangle(2, 3, rand);
    ...
    @Test void subtract_float_matrix() {
        FMatrixRMaj a = new FMatrixRMaj(2, 3, true, 0, 1, 2, 3, 4, 5);
        FMatrixRMaj c = RandomMatrices_FDRM.rectangle(2, 3, rand);
    ...
    @Test void elementMax_location() {
        ...
        var mat = new FMatrixRMaj(3, 3, true, 0, 1, -2, 3, 4, 5, 6, 7, -8);

        float m = CommonOps_FDRM.elementMax(mat, loc);
        assertEquals(7, m, UtilEjml.TEST_F32);
    ...
    @Test void elementMin_location() {
        ...
        float m = CommonOps_FDRM.elementMin(mat, loc);
        assertEquals(-3, m, UtilEjml.TEST_F32);
    ...
    @Test void elementMinAbs_location() {
        ...
        float m = CommonOps_FDRM.elementMinAbs(mat, loc);
        assertEquals(0, m, UtilEjml.TEST_F32);
    ...
    @Test void elementMaxAbs_location() {
        ...
        float m = CommonOps_FDRM.elementMaxAbs(mat, loc);
        assertEquals(8, m, UtilEjml.TEST_F32);
        assertEquals(2, loc.row);
    ...
    @Test void sumRows() {
        ...
        assertSame(output, CommonOps_FDRM.sumRows(input, output));
    ...
    @Test void minRows() {
        ...
        assertSame(output, CommonOps_FDRM.minRows(input, output));
    ...
    @Test void maxRows() {
        ...
        assertSame(output, CommonOps_FDRM.maxRows(input, output));
    ...
    @Test void sumCols() {
        ...
        assertSame(output, CommonOps_FDRM.sumCols(input, output));
    ...
    @Test void minCols() {
        ...
        assertSame(output, CommonOps_FDRM.minCols(input, output));
    ...
    @Test void maxCols() {
        ...
        assertSame(output, CommonOps_FDRM.maxCols(input, output));
    ...
    @Test void rref_case0() {
        ...
        found = CommonOps_FDRM.rref(A, -1, null);
        assertTrue(MatrixFeatures_FDRM.isEquals(found, expected));
    }

    /** Wide matrix with zeros in the first column. */
    @Test void rref_case1() {
        var A = new FMatrixRMaj(2, 3, true, new float[]{0, 2, 2, 0, 0, 2});
        FMatrixRMaj found = CommonOps_FDRM.rref(A, -1, null);
        var expected = new FMatrixRMaj(2, 3, true, new float[]{0, 1, 0, 0, 0, 1});
        assertTrue(MatrixFeatures_FDRM.isEquals(found, expected));
    }

    /** Tall matrix */
    @Test void rref_case2() {
        var A = new FMatrixRMaj(3, 2, true, new float[]{1, 2, 2, 4, 5, 2});
        FMatrixRMaj found = CommonOps_FDRM.rref(A, -1, null);
        var expected = new FMatrixRMaj(3, 2, true, new float[]{1, 0, 0, 1, 0, 0});
        assertTrue(MatrixFeatures_FDRM.isEquals(found, expected));
    }

    @Test void elementLessThan_float() {
    ...
    @Test void elementLessThanOrEqual_float() {
        FMatrixRMaj A = new FMatrixRMaj(3, 4);
        BMatrixRMaj expected = new BMatrixRMaj(3, 4);
        BMatrixRMaj found = new BMatrixRMaj(3, 4);
    ...
    @Test void elementMoreThan_float() {
        FMatrixRMaj A = new FMatrixRMaj(3, 4);
        BMatrixRMaj expected = new BMatrixRMaj(3, 4);
        BMatrixRMaj found = new BMatrixRMaj(3, 4);
    ...
    @Test void elementMoreThanOrEqual_float() {
        FMatrixRMaj A = new FMatrixRMaj(3, 4);
        BMatrixRMaj expected = new BMatrixRMaj(3, 4);
        BMatrixRMaj found = new BMatrixRMaj(3, 4);
    ...
    @Test void elementBoolean() {
        FMatrixRMaj A = RandomMatrices_FDRM.rectangle(5, 10, rand);
        FMatrixRMaj B = RandomMatrices_FDRM.rectangle(5, 10, rand);
