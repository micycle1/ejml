...
@Generated("org.ejml.dense.row.TestMatrixFeatures_DDRM")
public class TestMatrixFeatures_FDRM extends EjmlStandardJUnit {
    ...
    @Test void isDiagonalNotNegative() {
        FMatrixRMaj m = CommonOps_FDRM.identity(3);
        assertTrue(MatrixFeatures_FDRM.isDiagonalNotNegative(m));

        m.set(1, 1, 0);
        assertTrue(MatrixFeatures_FDRM.isDiagonalNotNegative(m));

        m.set(1, 1, -1);
        assertFalse(MatrixFeatures_FDRM.isDiagonalNotNegative(m));
    ...
    @Test void isSymmetric() {
        ...
        m.set(1, 2, 50);
        assertFalse(MatrixFeatures_FDRM.isSymmetric(m));
        ...
        m.set(1, 2, 5);
        CommonOps_FDRM.scale(Float.MAX_VALUE/20, m);
        assertTrue(MatrixFeatures_FDRM.isSymmetric(m));
        ...
        FMatrixRMaj scalar = new FMatrixRMaj(1, 1);
        assertTrue(MatrixFeatures_FDRM.isSymmetric(scalar));
    ...
    @Test void isSkewSymmetric() {
        ...
        m.set(1, 2, -5);
        assertFalse(MatrixFeatures_FDRM.isSkewSymmetric(m, UtilEjml.TEST_F32));
