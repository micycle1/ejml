...
@Generated("org.ejml.dense.row.TestCovarianceRandomDraw_DDRM")
public class TestCovarianceRandomDraw_FDRM extends EjmlStandardJUnit {
    ...
    @Test void modifyInput() {
        ...
        new CovarianceRandomDraw_FDRM(new Random(0xfeed), input);
