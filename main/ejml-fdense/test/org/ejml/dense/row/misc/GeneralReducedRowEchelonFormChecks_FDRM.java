 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.dense.row.misc.GeneralReducedRowEchelonFormChecks_DDRM")
public abstract class GeneralReducedRowEchelonFormChecks_FDRM extends EjmlStandardJUnit {
    ReducedRowEchelonForm_F32 alg;

    protected GeneralReducedRowEchelonFormChecks_FDRM(ReducedRowEchelonForm_F32 alg) {
        this.alg = alg;
    }
